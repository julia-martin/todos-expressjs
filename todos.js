...
app.post("/lists/:todoListId/todos/:todoId/toggle",
  ...
  catchError(async (req, res) => {
    ...
    let toggled = await res.locals.store.toggleTodo(+todoListId, +todoId);
...
app.post("/lists/:todoListId/todos",
  ...
  catchError( async (req, res) => {
    ...
    if (!errors.isEmpty()) {
      ...
      let added = await res.locals.store.addTodo(+todoListId, todoTitle);
  ...
  catchError(async (req, res) => {
    ...
    try {
      ...
      if (!errors.isEmpty()) {
        ...
        let updated = await res.locals.store.editTodoListTitle(+todoListId, todoListTitle);
